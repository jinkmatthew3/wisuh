...
public class RegisterCarSalonActivity extends Fragment {
    EditText etnama, etalamat, ethargaMobil, ethargaMotor, etjamBuka, etjamTutup, etdesc;
    Button btnmaps, btnRegister;
    ...
    public RegisterCarSalonActivity() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_register_car_salon_activity, container, false);
...
//                    Log.d("register", "createUserWithEmail:success");
                    ...
                    Salon salon = new Salon(alamat, desc,hargaMobil,hargaMotor,jamBuka,jamTutup,geoPoint,nama,0);
